...
public partial class NQgsCultivationOrb : NClickableControl
{
    ...
    private void BuildVisuals()
    {
        ...
        {
            Texture = QgsArt.Load("res://images/orbs/empty_orb.png"),
    ...
    private static Color ElementColor(QgsElement element)
    {
        return element switch
        {
            QgsElement.Earth => new Color(0.48f, 0.7f, 0.3f),
            QgsElement.Fire => new Color(0.92f, 0.36f, 0.18f),
            QgsElement.Water => new Color(0.24f, 0.58f, 0.88f),
            QgsElement.Wind => new Color(0.42f, 0.82f, 0.68f),
            QgsElement.Aether => new Color(0.95f, 0.78f, 0.3f),
